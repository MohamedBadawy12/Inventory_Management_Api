...
namespace CraftIQ.Inventory.Endpoints.Transactions.Update
{
                                                                                                             ...
                                                                                                             .WithActionResult
    {
        ...
        public override async Task<ActionResult> HandleAsync(UpdateTransactionRequest request, CancellationToken cancellationToken = default)
        {
