...
namespace CraftIQ.Inventory.Endpoints.Transactions.Create
{
                                                                                                            ...
                                                                                                            .WithActionResult<CreateTransactionResponse>
    {
        ...
        public override async Task<ActionResult<CreateTransactionResponse>> HandleAsync(CreateTransactionRequest request, CancellationToken cancellationToken = default)
        {
            ...
            var oResult = new CreateTransactionResponse(oCreateTransaction.TransactionId);
            return Ok(oResult);
        }
    }
}
