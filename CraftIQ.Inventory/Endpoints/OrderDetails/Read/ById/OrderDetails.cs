...
namespace CraftIQ.Inventory.Endpoints.OrderDetails.Read.ById
{
                                                                                                                     ...
                                                                                                                     .WithActionResult<ReadOrderDetailsResponse>
    {
        ...
        public override async Task<ActionResult<ReadOrderDetailsResponse>> HandleAsync(ReadOrderDetailByIdRequest request, CancellationToken cancellationToken = default)
        {
