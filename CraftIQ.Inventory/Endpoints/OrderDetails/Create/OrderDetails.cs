...
namespace CraftIQ.Inventory.Endpoints.OrderDetails.Create
{
                                                                                                                ...
                                                                                                                .WithActionResult<CreateOrderDetailResponse>
    {
        ...
        public override async Task<ActionResult<CreateOrderDetailResponse>> HandleAsync(CreateOrderDetailRequest request, CancellationToken cancellationToken = default)
        {
            ...
            var oResult = new CreateOrderDetailResponse(oCreateOrderDetail.OrderDetailId);
            return Ok(oResult);
        }
    }
}
