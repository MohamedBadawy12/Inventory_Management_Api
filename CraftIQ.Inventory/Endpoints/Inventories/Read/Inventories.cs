...
namespace CraftIQ.Inventory.Endpoints.Inventories.Read
{
                                                                                                     ...
                                                                                                     .WithActionResult<ReadInventoriesResponse>
    {
        ...
        public override async Task<ActionResult<ReadInventoriesResponse>> HandleAsync(CancellationToken cancellationToken = default)
        {
