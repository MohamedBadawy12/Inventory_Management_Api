...
namespace CraftIQ.Inventory.Endpoints.Inventories.Read.ById
{
                                                                                                                           ...
                                                                                                                           .WithActionResult<ReadInventoriesResponse>
    {
        ...
        public override async Task<ActionResult<ReadInventoriesResponse>> HandleAsync(ReadInventoryByIdRequest request, CancellationToken cancellationToken = default)
        {
